...
// A high-quality procedural noise function to displace the vertices.
const noiseSnippet = `
...
const SilkGeometry = ({ speed, scale, color, noiseIntensity, rotation, monochrome }) => {
  ...
  return (
    <mesh ref={meshRef} rotation={[0, 0, rotation]} scale={scale}>
      {/* High segment count plane for smooth waves */}
